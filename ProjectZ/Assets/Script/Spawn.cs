...
public class Spawn : MonoBehaviour
{
    ...
    void Start()
    {
        InvokeRepeating("EnemySpawn", 1.0f, 20.0f);
    }
    ...
    void EnemySpawn()
    {
        ...
        float posX = meObject.transform.position.x + Random.Range(-10f, 10f);  // X좌표 설정
        Debug.Log("x계산" + indexNum);
        float posZ = meObject.transform.position.z + Random.Range(-10f, 10f);  // Y좌표 설정
        ...
        Debug.Log("스폰끝!!!!" + enemy.transform.localPosition);
